    ...
    <div className="space-y-6">
      ...
      <section>
        ...
        <p className="mb-3 text-gray-700 dark:text-gray-300">
          Het systeem gebruikt een multi-tenant architectuur met:
        </p>
        <ul className="space-y-2 text-gray-700 dark:text-gray-300">
          <li className="flex items-start space-x-2">
            <span className="mt-1 text-blue-500">•</span>
            <span>
              Organisatie-level data isolatie via{' '}
          ...
          <li className="flex items-start space-x-2">
            <span className="mt-1 text-blue-500">•</span>
            <span>
              Sequentie nummering voor documenten (quotes, invoices, etc.)
            </span>
          </li>
          <li className="flex items-start space-x-2">
            <span className="mt-1 text-blue-500">•</span>
            <span>Migraties en seeders voor database versioning</span>
          </li>
        </ul>
        ...
        <div className="mt-4 rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
          ...
          <div className="grid grid-cols-1 gap-2 text-sm text-gray-700 md:grid-cols-2 dark:text-gray-300">
            <div>• Organizations, Members, Teams</div>
            <div>• Companies, Contacts, Opportunities</div>
            <div>• Projects, ProjectMilestones, Tasks</div>
            <div>• Products, Services, Suppliers</div>
            <div>• Quotes, PurchaseOrders, Invoices</div>
            <div>• Files (Azure Blob Storage referenties)</div>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border border-orange-200 bg-orange-50 p-5 dark:border-orange-800 dark:bg-orange-900/20">
            <h4 className="mb-3 text-xl font-semibold text-orange-900 dark:text-orange-100">
              Testing
            </h4>
            <ul className="ml-2 list-inside list-disc space-y-1 text-gray-700 dark:text-gray-300">
              <li>Client unit tests: Vitest/React Testing Library</li>
              <li>
                End-to-end tests: Playwright met multi-browser ondersteuning
              </li>
              <li>CI/CD: Geautomatiseerde tests bij elke push</li>
            </ul>
          </div>

          {/* Deployment */}
          <div className="rounded-lg border border-red-200 bg-red-50 p-5 dark:border-red-800 dark:bg-red-900/20">
            <h4 className="mb-3 text-xl font-semibold text-red-900 dark:text-red-100">
              Deployment
            </h4>
            <ul className="ml-2 list-inside list-disc space-y-1 text-gray-700 dark:text-gray-300">
              <li>
                Development: Automatische deployment naar Azure Container Apps
                bij push naar development branch
              </li>
              <li>Docker multi-stage build: Client build + server runtime</li>
              <li>
